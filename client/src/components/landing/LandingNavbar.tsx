...
const scrollToSection = (id: string) => {
    gsap.to(window, {
        duration: 1.2,          // control speed here
        scrollTo: {
            y: `#${id}`,
    ...
    return (
        <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-6 backdrop-blur-md border-b border-white/10">
            <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold tracking-tighter leading-none bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-white to-indigo-600 font-cinzel">
                    TUTORAIVE
                </span>
            </div>
