  ...
  return (
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-6 backdrop-blur-md border-b border-white/10">
          <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold tracking-tighter font-cinzel">TUTORAIVE</span>
          </div>
          <div className="hidden md:flex gap-8 items-center text-sm font-medium tracking-wide font-oswald" >
              ...
              <button className="bg-white text-black px-6 py-2 rounded-full hover:bg-indigo-50 transition-all active:scale-95 shadow-xl">
                  GET STARTED
              </button>
          </div>
      </nav>  )
