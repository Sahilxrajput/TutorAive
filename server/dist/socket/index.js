...
const joinLiveSession_handler_1 = require("./handlers/joinLiveSession.handler");
...
const leaveLiveSession_handler_1 = require("./handlers/leaveLiveSession.handler");
exports.io = null;
const initSocket = (httpServer) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    classroom.on("connection", (socket) => {
        ...
        socket.on("join:live-session", (0, joinLiveSession_handler_1.handleJoinLiveSession)(socket));
        ...
        socket.on("leave:live-session", (0, leaveLiveSession_handler_1.handleLeaveLiveSession)(socket));
        ...
        socket.on("disconnect", (0, leaveLiveSession_handler_1.handleLeaveLiveSession)(socket));
    });
});
